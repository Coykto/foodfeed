...
class BackendStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        search_machine, search_results_bucket = setup_search(self, dependency_layer, search_domain, openai_api_key)
        ...
        setup_telegram(self, dependency_layer, api, telegram_token, telegram_secret_header, search_machine, search_results_bucket)
